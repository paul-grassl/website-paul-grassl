...
# Rules & Process
1. If needed, rename exhibition photos to the convention `exhib_[YYYY]_[camelCaseTitle]_[index].jpg` (1-based index) in `public/assets/exhibitionImages/[YYYY]_[camelCaseTitle]/` before mapping them into frontmatter.
